...
export class MenuBarComponent implements AfterViewInit {
  ...
  private measureTabWidths(): void {
    ...
    const allTabs = this.menuTabService.getAllOfflineMenuTab();
  ...
  private checkWindowSize(): void {
    ...
    const allTabs: MenuTabModel[] = this.menuTabService.getAllOfflineMenuTab();
    ...
    this.menuPlus = this.menuTabService.getLastElements(hiddenCount, allTabs);
    this.menuTabs = this.menuTabService.getTabsNotInPlus(this.menuPlus, allTabs);
  }
